    ...
    return (
        <div className="p-8">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Bus Management {user?.name && ` - ${user.name}`}</h1>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {filteredBuses.map((bus) => (
                            <tr key={bus.id} className="hover:bg-gray-50 transition-colors">
                                <td className="px-6 py-4 font-medium text-gray-900">B{String(bus.id).padStart(3, '0')}</td>
                                ...
                                <td className="px-6 py-4 text-right space-x-2">
                                    <button onClick={() => openModal(bus)} className="text-blue-600 hover:text-blue-800">
